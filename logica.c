...
int main() {
    ...
    float dens1 = habitantes1 / areakm1;
    float dens2 = habitantes2 / areakm2;

    float per1 = pib1 / habitantes1;
    float per2 = pib2 / habitantes2;
    ...
    printf("PIB per Capita: %.1f bilhões de reais\n", per1);
    printf("Densidade Populacional: %.2f\n",dens1);
    ...
    printf("Área: %.3f km²\n", areakm2);
    printf("PIB per Capita: %.3f bilhões de reais\n", per2);
